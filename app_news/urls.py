...
from .views import NewsViews, EditNews, CommentNews, UnpublishedNewsViews, \
    NewsLoginView, logout_view, UsersViews, register_user, DetailsUserViews, FilterTagNewsViews, addnews
...
urlpatterns = [
    ...
    path('add_news/', addnews, name='add_news'),
